...
<template>
  ...
  >
    <el-form ref="formRef" :model="reactiveData.form" :rules="rules" label-position="top">
      <el-form-item :label="t('settings.group.groupType')" prop="groupTypeFlag">
        <el-select v-model="reactiveData.form.groupTypeFlag" @change="onGroupTypeChange">
      ...
      <el-form-item :label="t('settings.group.parentGroupId')" prop="parentGroupId">
        <el-tree-select
          ...
          :props="{ label: 'groupName', children: 'children', disabled: 'disabled' }"
      ...
      <el-form-item :label="t('settings.group.groupIndex')" prop="groupIndex">
        <el-input-number v-model="reactiveData.form.groupIndex" :min="0" :max="127" controls-position="right" />
      </el-form-item>
