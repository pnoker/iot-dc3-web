...
<template>
  ...
  >
    <template #filters>
      ...
      <el-form-item :label="$t('settings.label.entityType')" prop="entityTypeFlag">
        <el-select v-model="formData.entityTypeFlag" clearable :placeholder="$t('common.all')">
...
<script lang="ts" setup>
  ...
  const onSearch = (data: Record<string, any>) => {
    ...
    if (!params.entityTypeFlag) delete params.entityTypeFlag;
    emit('search', params);
  };
